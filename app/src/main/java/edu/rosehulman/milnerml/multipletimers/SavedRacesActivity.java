 ...
 */
public class SavedRacesActivity extends AppCompatActivity implements SavedRaceAdapter.Callback{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        if (savedInstanceState != null){
            ...
            for (int i = 0; i<count; i++){
                mAdapter.add((RunnerTime) runnerCards.get(i));
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int count = mAdapter.getmTimers().size();
        for (int i = 0; i<count; i++){
            runnerCards.add(mAdapter.getmTimers().get(i));
        }
    ...
    public Runnable updateTimer = new Runnable() {
        public void run() {
            ...
            mAdapter.updateRunnerCards(currentTime,updatedtime);
        }
                ...
                builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (timer == null) {
                            ...
                            mAdapter.add(new RunnerTime(name));
                        }
                    }
                });
